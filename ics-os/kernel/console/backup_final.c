...
int offset_min = 0;
int offset_max = 0;
int optionR=0;       //made it global so machechange siya everytime naeexecute yung console_execute
   ...
   if(strcmp(u,"history") == 0) {
      ...
      if (u != 0){
         do {
            ...
            if(strcmp(v, "-r") == 0) {   //once lang pwede magread ng data
